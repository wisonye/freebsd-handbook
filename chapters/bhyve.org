...
Plz DO NOT attach a physical interface to the virtual switch, that makes all network packets go through the virtual switch NIC, then you can use =PF= rules to control everything:)
